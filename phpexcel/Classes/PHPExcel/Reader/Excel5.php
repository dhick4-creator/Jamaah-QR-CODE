        ...
        foreach ($tokens as $token) {
            ...
            switch ($token['name']) {
                ...
                case 'tSub': // subtraction
                    ...
                    $formulaStrings[] = "$op1$space1space0[$token['data']]$op2";
                    unset($space0, $space1);
                    break;
                case 'tUplus': // unary plus
                case 'tUminus': // unary minus
                    $op = array_pop($formulaStrings);
                    $formulaStrings[] = "$space1space0[$token['data']]$op";
                    unset($space0, $space1);
                    break;
                case 'tPercent': // percent sign
                    $op = array_pop($formulaStrings);
                    $formulaStrings[] = "$op$space1space0[$token['data']]";
                    unset($space0, $space1);
                    break;
                ...
                case 'tFuncV': // function with variable number of arguments
                    if ($token['data']['function'] != '') {
                        ...
                        $formulaStrings[] = "$space1space0[$token['data']['function']](" . implode(',', $ops) . ")";
                        unset($space0, $space1);
                    } else {
                        // add-in function
                        $ops = array(); // array of operators
                ...
                case 'tMemArea':
                    ...
                    $formulaStrings[] = "$space1space0[$token['data']]";
                    unset($space0, $space1);
                    break;
